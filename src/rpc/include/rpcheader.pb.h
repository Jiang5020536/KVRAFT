...
template<> ::RPC::TestRequest* Arena::CreateMaybeMessage<::RPC::TestRequest>(Arena*);
template<> ::RPC::TestResponse* Arena::CreateMaybeMessage<::RPC::TestResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace RPC {
...
class TestRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:RPC.TestRequest) */ {
 public:
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_request_data();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
...
class TestResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:RPC.TestResponse) */ {
 public:
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_response_data();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
...
// string request_data = 1;
inline void TestRequest::clear_request_data() {
  request_data_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& TestRequest::request_data() const {
  // @@protoc_insertion_point(field_get:RPC.TestRequest.request_data)
  return _internal_request_data();
}
inline void TestRequest::set_request_data(const std::string& value) {
  _internal_set_request_data(value);
  // @@protoc_insertion_point(field_set:RPC.TestRequest.request_data)
}
inline std::string* TestRequest::mutable_request_data() {
  // @@protoc_insertion_point(field_mutable:RPC.TestRequest.request_data)
  return _internal_mutable_request_data();
}
inline const std::string& TestRequest::_internal_request_data() const {
  return request_data_.Get();
}
inline void TestRequest::_internal_set_request_data(const std::string& value) {
  
  request_data_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void TestRequest::set_request_data(std::string&& value) {
  
  request_data_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:RPC.TestRequest.request_data)
}
inline void TestRequest::set_request_data(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  request_data_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:RPC.TestRequest.request_data)
}
inline void TestRequest::set_request_data(const char* value,
    size_t size) {
  
  request_data_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:RPC.TestRequest.request_data)
}
inline std::string* TestRequest::_internal_mutable_request_data() {
  
  return request_data_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* TestRequest::release_request_data() {
  // @@protoc_insertion_point(field_release:RPC.TestRequest.request_data)
  return request_data_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TestRequest::set_allocated_request_data(std::string* request_data) {
  ...
  request_data_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), request_data,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:RPC.TestRequest.request_data)
}
inline std::string* TestRequest::unsafe_arena_release_request_data() {
  // @@protoc_insertion_point(field_unsafe_arena_release:RPC.TestRequest.request_data)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return request_data_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void TestRequest::unsafe_arena_set_allocated_request_data(
    std::string* request_data) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (request_data != nullptr) {
  ...
  request_data_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      request_data, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:RPC.TestRequest.request_data)
}
...
// string response_data = 1;
inline void TestResponse::clear_response_data() {
  response_data_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& TestResponse::response_data() const {
  // @@protoc_insertion_point(field_get:RPC.TestResponse.response_data)
  return _internal_response_data();
}
inline void TestResponse::set_response_data(const std::string& value) {
  _internal_set_response_data(value);
  // @@protoc_insertion_point(field_set:RPC.TestResponse.response_data)
}
inline std::string* TestResponse::mutable_response_data() {
  // @@protoc_insertion_point(field_mutable:RPC.TestResponse.response_data)
  return _internal_mutable_response_data();
}
inline const std::string& TestResponse::_internal_response_data() const {
  return response_data_.Get();
}
inline void TestResponse::_internal_set_response_data(const std::string& value) {
  
  response_data_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void TestResponse::set_response_data(std::string&& value) {
  
  response_data_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:RPC.TestResponse.response_data)
}
inline void TestResponse::set_response_data(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  response_data_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:RPC.TestResponse.response_data)
}
inline void TestResponse::set_response_data(const char* value,
    size_t size) {
  
  response_data_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:RPC.TestResponse.response_data)
}
inline std::string* TestResponse::_internal_mutable_response_data() {
  
  return response_data_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* TestResponse::release_response_data() {
  // @@protoc_insertion_point(field_release:RPC.TestResponse.response_data)
  return response_data_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TestResponse::set_allocated_response_data(std::string* response_data) {
  ...
  response_data_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), response_data,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:RPC.TestResponse.response_data)
}
inline std::string* TestResponse::unsafe_arena_release_response_data() {
  // @@protoc_insertion_point(field_unsafe_arena_release:RPC.TestResponse.response_data)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return response_data_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void TestResponse::unsafe_arena_set_allocated_response_data(
    std::string* response_data) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (response_data != nullptr) {
  ...
  response_data_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      response_data, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:RPC.TestResponse.response_data)
}
